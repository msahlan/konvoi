...
*/
                ...
                if($img_cnt > 0){
                    ...
                    $display = '<div style="width:100px;height:100px;clear:both;display:block;cursor:pointer;position:relative;padding:0px;overflow-y:auto;overflow-x:hidden;">'.$display.'</div>';
