...
class AssetlocationController extends AdminController {
    ...
    private $default_heads = array(
        ...
        array('Dept.',array('search'=>true,'sort'=>true)),
    ...
    private $default_fields = array(
        ...
        array('Coy',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true )),
        array('Dept',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
