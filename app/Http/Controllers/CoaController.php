...
class CoaController extends AdminController {
    ...
    public function getHistory($id)
    {
        ...
        $this->crumb->addCrumb('History',url( strtolower($this->controller_name) ));
    ...
    public function makeActions($data)
    {
        ...
        $edit = '<a href="'.url('advertiser/edit/'.$data['ACNT_CODE']).'"><i class="fa fa-edit"></i> Update</a>';
        $dl = '<a href="'.url('brochure/dl/'.$data['ACNT_CODE']).'" target="new"><i class="fa fa-download"></i> Download</a>';
        $print = '<a href="'.url('brochure/print/'.$data['ACNT_CODE']).'" target="new"><i class="fa fa-print"></i> Print</a>';
        ...
        $history = '<a href="'.url('advertiser/history/'.$data['ACNT_CODE']).'"><i class="fa fa-clock-o"></i> History</a>';
