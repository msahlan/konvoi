...
class InvoiceController extends AdminController {
    ...
    private $default_heads = array(
        array('Invoice #',array('search'=>true,'sort'=>true)),
        array('Issued To',array('search'=>true,'sort'=>true)),
        array('Issue Date',array('search'=>true,'sort'=>true,'daterange'=>true)),
        array('Due Date',array('search'=>true,'sort'=>true,'daterange'=>true)),
    ...
    private $default_fields = array(
        array('InvoiceNumber',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
        array('IssuedTo',array('kind'=>'text' , 'query'=>'like', 'pos'=>'both','show'=>true)),
        array('IssueDate',array('kind'=>'daterange' , 'query'=>'like', 'pos'=>'both','show'=>true)),
        array('DueDate',array('kind'=>'daterange' , 'query'=>'like', 'pos'=>'both','show'=>true)),
    ...
    public function __construct()
    {
        ...
        //$this->model = DB::collection('Invoices');
        $this->title = 'Invoices';
    ...
    public function postDirscan()
    {
        ...
        foreach ($files as $file) {
            ...
            $d = Invoice::where('Fcallcode','=',$f)->first();
            if($d){
...
//<button data-rel="tooltip" type="button" class="btn btn-primary m-b-10 f-left" data-toggle="tooltip" data-placement="left" title="" data-original-title="Tooltip on left">Left</button>
    ...
    public function getPrintlabel($sessionname, $printparam, $format = 'html' )
    {
        ...
        $labels = Invoice::whereIn('_id', $session)->get()->toArray();
        ...
        $products = Invoice::whereIn('_id',$skus)->get()->toArray();
