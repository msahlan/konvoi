...
class UploadController extends Controller {
    ...
    public function postLogo()
    {
        ...
        $destinationPath = realpath('storage/logo').'/'.$rstring;
        ...
        if($is_image){
            ...
            $image_size_array = array(
                'thumbnail_url'=> url('storage/logo/'.$rstring.'/'.$ps['thumbnail']['prefix'].$filename),
                'square_url'=> url('storage/logo/'.$rstring.'/'.$ps['square']['prefix'].$filename),
                'large_url'=> url('storage/logo/'.$rstring.'/'.$ps['large']['prefix'].$filename),
                'medium_url'=> url('storage/logo/'.$rstring.'/'.$ps['medium']['prefix'].$filename),
                'full_url'=> url('storage/logo/'.$rstring.'/'.$ps['full']['prefix'].$filename),
            );
        ...
        if($uploadSuccess){
            $item = array(
                    ...
                    'url'=> url('storage/logo/'.$rstring.'/'.$filename),
                    'temp_dir'=> $destinationPath,
                    'file_id'=> $rstring,
                    'is_image'=>$is_image,
                    'is_audio'=>$is_audio,
    ...
    public function postAvatar()
    {
        ...
        if($uploadSuccess){
            $item = array(
                    ...
                    'parent_id'=> $parent_id,
                    'parent_class'=> $parent_class,
                    'url'=> url('storage/avatar/'.$rstring.'/'.$filename),
                    'temp_dir'=> $destinationPath,
                    'file_id'=> $rstring,
                    'is_image'=>$is_image,
                    'is_audio'=>$is_audio,
