...
class AssetController extends AdminController {
    ...
    public function makeActions($data)
    {
        ...
        $edit = '<a href="'.url('asset/edit/'.$data['_id']).'"><i class="fa fa-edit"></i> Update</a>';
        ...
        $stat = '<a href="'.url('stats/asset/'.$data['_id']).'"><i class="fa fa-line-chart"></i> Stats</a>';

        $history = '<a href="'.url('asset/history/'.$data['_id']).'"><i class="fa fa-clock-o"></i> History</a>';
