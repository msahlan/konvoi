<a class="btn btn-raised btn-transparent btn-info btn-sm" id="reschedule_pickup"><i class="fa fa-calendar"></i> Reschedule</a>
<a class="btn btn-raised btn-transparent btn-info btn-sm" id="reassign_to_device"><i class="fa fa-phone-square"></i> Reassign Device</a>
<a class="btn btn-raised btn-transparent btn-info btn-sm" id="reassign_to_courier"><i class="fa fa-user"></i> Reassign Courier</a>
<br />
...
<div id="reassign-courier-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-raised btn-primary" id="do-reassign-courier">Reassign Courier</button>
    </div>
</div>
...
<div id="device-reassign-modal" class="modal fade large" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Cancel</button>
        <button class="btn btn-raised btn-primary" id="do-device-reassign">Reassign Device</button>
    </div>
</div>
...
<div id="reset-pickup-date-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Cancel</button>
        <button class="btn btn-raised btn-primary" id="do-reschedule">Reschedule</button>
    </div>
</div>
