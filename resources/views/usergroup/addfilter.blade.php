...
<a class="btn btn-raised btn-info btn-sm" id="refresh_filter">Refresh</a>
<a class="btn btn-raised btn-info btn-sm" id="print_barcodes"><i class="fa fa-print"></i> Print Selected Barcodes</a>
<a class="btn btn-raised btn-info btn-sm" id="move_outlets">Move Selection's Outlets</a>
...
<div id="assign-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-footer">
    ...
    <button class="btn btn-raised btn-primary" id="do-assign">Move</button>
  </div>
</div>
