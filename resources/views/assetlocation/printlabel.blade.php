                    ...
                    <td style="text-align:center">
                        @if($code_type == 'qr')
                            ...
                            <?php
                                ...
                                $qrstring = $l['AssetNo'].'|'.$l['SerialNumber'];

                            ?>

                            <img src="{{ URL::to('qr/'.urlencode(base64_encode($qrstring)) ) }}" class="barcode" alt="{{ $l['AssetNo'] }}" />
                        @else
                            <img src="{{ URL::to('pdf417/'.urlencode(base64_encode($l['AssetNo'])) ) }}" class="barcode" alt="{{ $l['AssetNo'] }}" />
                        @endif
                    </td>
                </tr>
                <tr>
