<a class="btn btn-raised btn-transparent" id="push_message"><i class="fa fa-send"></i> Push Message</a>
<a class="btn btn-raised btn-transparent" id="sync_legacy"><i class="fa fa-refresh"></i> Sync Parse Data</a>
...
<div id="push-message-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-raised btn-primary" id="do-send">Send</button>
    </div>
</div>
...
<div id="push-device-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Cancel</button>
        <button class="btn btn-raised btn-primary" id="do-send-device">Send</button>
    </div>
</div>
