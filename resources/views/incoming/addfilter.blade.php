...
<a class="btn btn-raised btn-transparent btn-info btn-sm" id="set_pickup"><i class="fa fa-calendar"></i> Assign Delivery Date</a>

{{--
<a class="btn btn-raised btn-sm btn-info btn-transparent" id="download-awb-xls"><i class="fa fa-download"></i> Download AWB Template</a>

<a href="{{ URL::to($importawburl) }}" class="btn btn-raised btn-sm btn-transparent btn-primary"><i class="fa fa-upload"></i> Update AWB</a>
--}}
...
<div id="set-pickup-date-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Cancel</button>
        <button class="btn btn-raised btn-primary" id="do-set-date">Set</button>
    </div>
</div>
