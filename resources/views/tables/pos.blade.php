   ...
   <div class="col-md-6">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                    ...
                    <div class="row-fluid">
                        <div class="col-md-6">
                            {{ Former::button('Cancel')->id('btn-cancel')->class('btn btn-raised btn-danger btn-block btn-large') }}
                        </div>
                        <div class="col-md-6">
                            {{ Former::button('Pay')->id('btn-pay')->class('btn btn-raised btn-primary btn-block btn-large') }}
                        </div>
                    </div>
            </div>
        </div>
...
<div id="print-modal" class="modal fade medium" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <button class="btn btn-raised btn-primary" id="print-content">Print</button>
    </div>
</div>
...
<div id="pay-modal" class="modal fade large" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-footer">
    <button class="btn btn-raised btn-medium" data-dismiss="modal" aria-hidden="true">Close</button>
    <button class="btn btn-raised btn-primary btn-medium" id="print-trans" >Print</button>
    <button class="btn btn-raised btn-danger btn-medium" id="finalize-trans">Finalize</button>
  </div>
</div>
