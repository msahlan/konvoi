    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            @if(isset($can_add) && $can_add == true)
                <a href="{{ URL::to($addurl) }}" class="btn btn-raised btn-sm btn-transparent btn-primary"><i class="fa fa-plus"></i> Add</a>
                <a href="{{ URL::to($importurl) }}" class="btn btn-raised btn-sm btn-transparent btn-primary"><i class="fa fa-upload"></i> Excel</a>
            @endif
            ...
            @if(isset($is_report) && $is_report == true)
                ...
                ?>
                <a target="_blank" href="{{ URL::to($print_url) }}" class="btn btn-raised btn-sm btn-transparent btn-primary"><i class="fa fa-print"></i> Print</a>

                <a target="_blank" href="{{ URL::to($pdf_url) }}" class="btn btn-raised btn-sm btn-transparent btn-primary"><i class="fa fa-print"></i> PDF</a>
...
<div class="panel panel-flat table-content-wrapper">
